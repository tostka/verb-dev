...
```
Compare-FilesTDO [-Ref] <FileInfo[]> [-Diff] <FileInfo[]> [-ContextLines <Int32>] [<CommonParameters>]
```
...
### EXAMPLE 1
```
Compare-Filestdo -Ref C:\sc\powershell\MergerScripts\CreateCloudOnlyUsers_catapult_20221019vers.ps1 -Diff C:\sc\powershell\MergerScripts\CreateCloudOnlyUsers_KADRITS.ps1
```
...
[https://dfinke.github.io/powershell,%20ai,%20chatgpt,%20codegen/2024/09/03/git-diff-tool-in-powershell.html](https://dfinke.github.io/powershell,%20ai,%20chatgpt,%20codegen/2024/09/03/git-diff-tool-in-powershell.html)
