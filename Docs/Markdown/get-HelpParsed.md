...
Between get-HelpParsed/parse-Help and get-VersionInfo, both do largely the same thing, but this uses a more flexible get-help call syntax less likely to mis-parse CBH out of a given target.
This variant has also been continuosly updated, get-VersionInfo has been static since 4/2020.
...
[ValidateScript({Test-Path $_})], [ValidateScript({Test-Path $_})]](https://github.com/verb-dev
