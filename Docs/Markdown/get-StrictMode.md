...
state after possibly being changed within a script.
Add this function
to your $profile. 
...
This includes uninitialized variables in strings.
...
https://www.powershellgallery.com/packages/strictmode/2.1](https://github.com/tostka/verb-Text
