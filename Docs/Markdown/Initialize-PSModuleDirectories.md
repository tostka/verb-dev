...
```
Initialize-PSModuleDirectories [-ModuleSourcePath] <Array> [-ModuleDestinationPath] <String>
 [[-DefaultModDirs] <String[]>] [-whatIf] [<CommonParameters>]
```
...
TRY {
    ...
    $PassStatus += ";ERROR";
    write-warning  "$(get-date -format 'HH:mm:ss'): Failed processing $($_.Exception.ItemName).
