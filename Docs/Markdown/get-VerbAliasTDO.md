...
## SYNOPSIS
get-VerbAliasTDO.ps1 - Returns the 'standard' alias prefix for a given Powershell verb (according to MS documentation).
(E.g.
the common verb 'copy' has uses the standard alias prefix 'cp')
